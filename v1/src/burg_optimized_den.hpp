#ifndef __BURG_OPTIMIZED_DEN_HPP__
#define __BURG_OPTIMIZED_DEN_HPP__
...
public:
    burg_optimized_den(const std::size_t max_size) : max_size{max_size}, max_order{max_size - 1}, f(max_size), b(max_size)
    {
#ifdef DEBUG
        assert(max_size > 0);
