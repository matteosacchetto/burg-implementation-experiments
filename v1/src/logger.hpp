...
public:
    ...
    static void info(std::string s, std::size_t indent = 0) {
        std::cout << "\u001B[46m\u001B[37m\u001B[1m  INFO  \u001B[22m\u001B[39m\u001B[49m " << logger::format(s, 9+ indent);
    };

    static void error(std::string s, std::size_t indent = 0) {
        std::cout << "\u001B[41m\u001B[37m\u001B[1m  ERROR  \u001B[22m\u001B[39m\u001B[49m " << logger::format(s, 10 + indent);
    };

    static void warning(std::string s, std::size_t indent = 0) {
        std::cout << "\u001B[43m\u001B[30m\u001B[1m  WARN  \u001B[22m\u001B[39m\u001B[49m " << logger::format(s, 9 + indent);
    };

    static void success(std::string s, std::size_t indent = 0) {
        std::cout << "\u001B[42m\u001B[37m\u001B[1m  SUCCESS  \u001B[22m\u001B[39m\u001B[49m " << logger::format(s, 12 + indent);
    };
};
